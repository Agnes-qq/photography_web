...
const filmPhotos = [
  ...
  },
  {
    ...
    category: "landscape",
    src: "/placeholder.svg?height=400&width=400",
    alt: "Film Landscape 1",
  },
  {
    id: 4,
    category: "street",
    src: "/placeholder.svg?height=400&width=400",
    alt: "Film Street Photography 2",
  },
  {
    id: 5,
    category: "portrait",
  ...
  },
  {
    ...
    category: "landscape",
    src: "/placeholder.svg?height=400&width=400",
    alt: "Film Landscape 2",
  },
  {
    id: 7,
    category: "street",
    src: "/placeholder.svg?height=400&width=400",
    alt: "Film Street Photography 3",
  },
  {
    id: 8,
    category: "portrait",
  ...
  },
  {
    ...
    category: "landscape",
    src: "/placeholder.svg?height=400&width=400",
    alt: "Film Landscape 3",
  },
  {
    id: 10,
    category: "street",
    src: "/placeholder.svg?height=400&width=400",
    alt: "Film Street Photography 4",
  },
]
...
export default function FilmPage() {
  ...
  const filteredPhotos =
    activeFilter === "all" ? filmPhotos : filmPhotos.filter((photo) => photo.category === activeFilter)
    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="text-center mb-16">
          <h1 className="text-5xl md:text-6xl font-normal text-black mb-4 typewriter-heading">Film Photography</h1>
          <p className="text-gray-600 typewriter-body mb-8">
            Captured on analog film with timeless grain and authentic character
          </p>
        ...
        {filteredPhotos.length === 0 && (
          <div className="text-center py-20">
            <p className="text-gray-500 typewriter-body tracking-wide">No film photographs found for this category.</p>
          </div>
        )}
      </main>
    </div>
